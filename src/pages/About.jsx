  ...
  return (
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        <img className="w-full md:max-w-[450px]" src={assets.about_img || "/placeholder.svg"} alt="" />
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            QuickCart was born out of a passion for innovation and a desire to revolutionize the way people shop online.
          ...
          <p>
            Our mission at QuickCart is to empower customers with choice, convenience, and confidence. We're dedicated to
